...
Definition at line 38 of file disjointset.\+h.
...
Definition at line 47 of file disjointset.\+h.
...
\begin{DoxyParams}{Parameters}
{\em node\+:要查找的结点。它必须非空，否则抛出异常} & 该操作简单沿着指向父节点的指针找到树的根。树的根的特征是：它的父节点就是它本身。 若结点不在不相交集合森林中（当结点的父节点指针为空时），则抛出异常。\\
\hline
\end{DoxyParams}
...
Definition at line 105 of file disjointset.\+h.
...
Definition at line 81 of file disjointset.\+h.
...
Definition at line 132 of file disjointset.\+h.
...
\hypertarget{struct_introduction_to_algorithm_1_1_set_algorithm_1_1_disjoint_set_node_a03e58ee7a2d6949283fafcd1de53e53b}{}\index{Introduction\+To\+Algorithm\+::\+Set\+Algorithm\+::\+Disjoint\+Set\+Node@{Introduction\+To\+Algorithm\+::\+Set\+Algorithm\+::\+Disjoint\+Set\+Node}!value@{value}}
