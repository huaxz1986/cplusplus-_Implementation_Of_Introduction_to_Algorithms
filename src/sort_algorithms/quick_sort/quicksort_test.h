...
TEST(test_quick_sort, test_C_array)
{
    ...
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<int*,int>(data1+0,data1+10);
    std::sort(comparedata2,comparedata2+10);
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<int*,int>(data2+0,data2+10);
    std::sort(comparedata3,comparedata3+10);
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<int*,int>(data3+0,data3+10);
    std::sort(comparedata4,comparedata4+1);
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<int*,int>(data4+0,data4+1);
...
TEST(test_quick_sort, test_std_container)
{
    ...
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<Iterator,int>(data1.begin(),data1.end());
    std::sort(comparedata2.begin(),comparedata2.end());
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<Iterator,int>(data2.begin(),data2.end());
    std::sort(comparedata3.begin(),comparedata3.end());
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<Iterator,int>(data3.begin(),data3.end());
    std::sort(comparedata4.begin(),comparedata4.end());
    IntrodunctionToAlgorithm::SortAlgorithm::quick_sort<Iterator,int>(data4.begin(),data4.end());
